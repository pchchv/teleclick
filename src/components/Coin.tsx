...
import Animated, {useSharedValue, withTiming, useAnimatedStyle, SlideOutUp } from "react-native-reanimated";
import { Dimensions, Platform, Pressable, StyleSheet, GestureResponderEvent, View, Image, Text } from "react-native";
